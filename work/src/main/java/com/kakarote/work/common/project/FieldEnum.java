...
public enum FieldEnum {
    ...
    public static List<FieldEnum> getNoShowFieldEnum(Integer mapFlag) {
        ...
        switch (mapFlag){
            case 0:
                biDashboardNoShowFieldEnum = Arrays.asList( FieldEnum.FILE
                        , FieldEnum.DATE_INTERVAL
                        , FieldEnum.HANDWRITING_SIGN
                        , FieldEnum.DESC_TEXT
                        , FieldEnum.DETAIL_TABLE
                        , FieldEnum.CALCULATION_FUNCTION
                        , FieldEnum.FIELD_GROUP
                        , FieldEnum.RTF
                );
                break;
            case 1:
                biDashboardNoShowFieldEnum = Arrays.asList( FieldEnum.NUMBER
                        , FieldEnum.FLOATNUMBER
                        , FieldEnum.PERCENT
                );
                break;
            case 2:
                biDashboardNoShowFieldEnum = Arrays.asList( FieldEnum.MAP_ADDRESS
                        , FieldEnum.ADDRESS
                        , FieldEnum.AREA_POSITION
                        , FieldEnum.CURRENT_POSITION
                );
                break;
            default:
        }
